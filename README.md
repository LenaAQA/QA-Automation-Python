...
<h3> <p align="justify">Я инженер по тестированию ПО (Fullstack QA) с опытом ручного и автоматизированного тестирования веб- и API-сервисов. Пишу автотесты на Python (Pytest, Selenium, HTTPX, Requests), также использовала TypeScript и Go.<br> 
